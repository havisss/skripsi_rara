...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css"
        integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLMDJ/8dYm2I7c4kH+cTz+8S8tXvY0o8J/e+8+xGzB/Q6g5g4p5v6x5o4c9h5q5g=="
    ...
    <style>
        * {
        ...
        .social-links a {
            ...
            /* Font Awesome specific styling for social links */
            font-size: 1rem;
            line-height: 1;
        }
        ...
        .feature-icon i {
            /* Style for Font Awesome icons inside feature-icon */
            font-size: 1.5rem;
            color: #4c6fff;
        }
        ...
        .service-icon i {
            /* Style for Font Awesome icons inside service-icon */
            color: #4c6fff;
            font-size: 2rem;
        }
...
<body>
    <div class="top-bar">
        <div class="top-bar-content">
            <div class="top-left">
                <span><i class="fa-solid fa-calendar-days"></i> Sunday - Sat 9.00 - 18.00</span>
                <span><i class="fa-solid fa-location-dot"></i> Visa Consultants, Bali, Indonesia</span>
            </div>
            <div class="top-right">
                <span><i class="fa-solid fa-envelope"></i> youremail@gmail.com</span>
                <div class="social-links">
                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                    <a href="#"><i class="fab fa-twitter"></i></a>
                    <a href="#"><i class="fab fa-linkedin-in"></i></a>
                </div>
                <a href="tel:+6218002001234" class="phone-number"><i class="fa-solid fa-phone"></i> +62
                    1800-200-1234</a>
            </div>
        </div>
    </div>
    ...
    <section class="consultation-services">
        ...
        <div class="services-grid">
            <div class="service-card">
                ...
                <a href="#" class="view-more">View More Info <i class="fa-solid fa-arrow-right"></i></a>
            </div>
